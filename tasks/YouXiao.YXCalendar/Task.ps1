...
$Fetch = {
    ...
    $Object1 = Invoke-RestMethod @WebRequestParameters -Uri $Uri1 | ConvertFrom-Html
    $Object2 = Invoke-RestMethod @WebRequestParameters -Uri $Uri2 | ConvertFrom-Html
    ...
    # InstallerUrls
    $InstallerUrl = "https://static.youxiao.cn/yxcalendar/yxcalendar_v${Version}.exe"
    ...
    # ReleaseNotes
    $ReleaseNotes = $Object2.SelectNodes('//*[@id="post-350"]/div[2]/ol[1]/li/text()').Text | ConvertTo-OrderedList | Format-Text
