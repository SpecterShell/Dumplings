...
$Ping = {
    ...
    $Object1 = (Invoke-RestMethod -Uri $Uri1) | Where-Object -Property 'OS' -EQ -Value 'win-wpf-client'
    ...
    # InstallerUrl
    $Result.InstallerUrl = @(
        "https://pkg-cdn.jianguoyun.com/static/exe/installer/$($Result.Version)/NutstoreWindowsWPF_Full_$($Result.Version).exe"
    )
