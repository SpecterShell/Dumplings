...
$Ping = {
    ...
    # InstallerUrl
    $Result.InstallerUrl = Get-RedirectedUrl -Uri $Object1.SelectSingleNode('//*[@id="banner_box_pinyin"]/div[1]/a').Attributes['href'].Value
...
$Pong = {
    ...
    $Uri2 = 'http://qq.pinyin.cn/js/history_info_pc.js'
