...
function Get-ReleaseNotes {
  try {
    $Object3 = Invoke-RestMethod -Uri 'https://coenfin.nl/wp-admin/admin-ajax.php?action=get_wdtable&table_id=6' -Method Post -Body @{
      draw               = '1'
      'columns[0][data]' = '0'
...
$Object1 = Invoke-WebRequest -Uri 'https://coenfin.nl/pdfinvoice2ubl/'
