...
$Object1 = Invoke-WebRequest -Uri 'https://www.altova.com/thankyou?ProductCode=AD&EditionCode=XX&InstallerType=IntegrationPackage&Lang=en&OperatingSystem=win32'
