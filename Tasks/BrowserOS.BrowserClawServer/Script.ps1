$Object1 = (Invoke-GitHubApi -Uri 'https://api.github.com/repos/browseros-ai/BrowserOS/releases?per_page=20').Where({ -not $_.prerelease -and $_.tag_name -like 'claw-server/v*' }, 'First')
