...
$this.CurrentState.Installer += [ordered]@{
  ...
  InstallerUrl = $Object1.assets.Where({ $_.name.EndsWith('.zip') -and $_.name -match 'windows' -and $_.name -match 'cpu' -and $_.name -match 'voicevox' -and $_.name -notmatch 'directml' }, 'First')[0].browser_download_url | ConvertTo-UnescapedUri
}
