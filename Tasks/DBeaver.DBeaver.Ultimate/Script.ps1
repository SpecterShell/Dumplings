...
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x64'
  Scope        = 'user'
  InstallerUrl = "https://downloads.dbeaver.net/ultimate/$($this.CurrentState.Version)/dbeaver-ue-$($this.CurrentState.Version)-windows-x86_64.exe"
...
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'arm64'
  Scope        = 'user'
  InstallerUrl = "https://downloads.dbeaver.net/ultimate/$($this.CurrentState.Version)/dbeaver-ue-$($this.CurrentState.Version)-windows-aarch64.exe"
  ProductCode  = 'DBeaverUltimate (current user)'
}
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'arm64'
