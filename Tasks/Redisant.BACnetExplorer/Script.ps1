$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/chenjing1294/BACnetExplorer-release/releases/latest"
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.redisant.com/bacnetexplorer/download' | ConvertFrom-Html
    ...
    try {
      $Object3 = Invoke-WebRequest -Uri 'https://www.redisant.cn/bacnetexplorer/download' | ConvertFrom-Html
