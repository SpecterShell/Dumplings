$Object1 = Invoke-WebRequest -Uri 'https://www.tachosys.com/Product/TachographFileViewer'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    foreach ($Installer in $this.CurrentState.Installer) {
      ...
      $InstallerFile2 = Join-Path $InstallerFileExtracted 'Tachograph File Viewer.msi'
      # ProductCode
