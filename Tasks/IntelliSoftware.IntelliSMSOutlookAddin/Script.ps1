...
$Prefix = 'https://www.intellisms.co.uk/products/downloads/downloadfiles/default.aspx?prgid=2'
$Object1 = Invoke-WebRequest -Uri $Prefix

$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = Join-Uri $Prefix $Object1.Links.Where({ try { $_.href.EndsWith('.msi') -and -not $_.href.Contains('x86') -and -not $_.href.Contains('x64') } catch {} }, 'First')[0].href | ConvertTo-UnescapedUri
}
