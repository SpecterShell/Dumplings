function Read-Installer {
  ...
  # Version
  # The installer contains three components, each with a different version. The main program has no version, neither does the installer. Use the Last Modified date as the version.
  $this.CurrentState.Version = $this.CurrentState.LastModified | Get-Date -Format 'yyyy.MM.dd'
  # InstallerSha256
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = 'https://timi.global.ssl.fastly.net/TIMi_Full/TIMiSetup_Full.exe'
}
