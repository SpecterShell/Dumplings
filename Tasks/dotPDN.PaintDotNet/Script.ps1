...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    7z.exe e -aoa -ba -bd -y -o"${ExtractedNestedInstallerFileX64}" $NestedInstallerFileX64 'x64\PaintDotNet_x64.msi' | Out-Host
    ...
    7z.exe e -aoa -ba -bd -y -o"${ExtractedNestedInstallerFileARM64}" $NestedInstallerFileARM64 'arm64\PaintDotNet_arm64.msi' | Out-Host
