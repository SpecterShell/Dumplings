# x86
$Object1 = Invoke-RestMethod -Uri 'https://utyautoupdate.synology.com/getUpdate/CloudStationDrive?os=windows&bits=32&include_beta=false'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = (Invoke-WebRequest -Uri 'https://www.synology.com/api/releaseNote/findChangeLog?identify=CloudStationDrive&lang=en-us').Content | ConvertFrom-Json -AsHashtable
