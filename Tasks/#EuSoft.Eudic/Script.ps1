...
if (Test-Path -Path $OldReleaseNotesPath) {
  $Global:DumplingsStorage['Eudic'] = $OldReleaseNotes = Get-Content -Path $OldReleaseNotesPath -Raw | ConvertFrom-Yaml -Ordered
} else {
  $Global:DumplingsStorage['Eudic'] = $OldReleaseNotes = [ordered]@{}
}
