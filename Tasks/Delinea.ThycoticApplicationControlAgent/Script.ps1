# x86
$Object1 = $Global:DumplingsStorage.DelineaDownloadPage.SelectSingleNode('//tr[contains(./td[2], "Application Control Agent (x86)")]')
$VersionX86 = [regex]::Match($Object1.SelectSingleNode('./td[1]').InnerText, '(\d+(?:\.\d+)+)').Groups[1].Value
# x64
$Object2 = $Global:DumplingsStorage.DelineaDownloadPage.SelectSingleNode('//tr[contains(./td[2], "Application Control Agent (x64)")]')
