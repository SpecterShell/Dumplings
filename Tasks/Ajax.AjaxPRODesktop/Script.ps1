...
$Object1 = Invoke-WebRequest -Uri 'https://ajax.systems/pro-desktop/'

# Installer
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x64'
  InstallerUrl = $Object1.Links.Where({ $_.href.EndsWith('.exe') -and $_.href -match 'AjaxSetup64' }, 'First')[0].href
}
