$Object1 = $Global:DumplingsStorage.ADInstrumentsApps.Where({ $_.ID -eq 'TrignoWirelessSystem' }, 'First')[0]
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = "https://cdn.adinstruments.com/Installers/win/Trigno Wireless_$($this.CurrentState.Version).msi"
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.adinstruments.com/support/downloads/windows/trigno-wireless-device-enabler' | ConvertFrom-Html
