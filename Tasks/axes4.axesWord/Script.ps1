...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Global:DumplingsStorage.Axes4DownloadPage.Links.Where({ try { $_.href.Contains('axesWord') -and $_.href -match 'Setup' -and $_.OuterHTML -notmatch 'beta' } catch {} }, 'First')[0].href
}
