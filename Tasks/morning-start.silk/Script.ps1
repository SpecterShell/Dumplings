$Object1 = Invoke-GitHubApi -Uri 'https://api.github.com/repos/morning-start/silk/releases/latest'
  ...
  'New|Changed|Updated' {
    ...
    try {
      ...
      $this.CurrentState.Locale += [ordered]@{
        Locale = 'zh-CN'
        Key    = 'ReleaseNotesUrl'
        Value  = $ReleaseNotesUrl = 'https://github.com/morning-start/silk/blob/HEAD/CHANGELOG.md'
      }

      $Object2 = Invoke-RestMethod -Uri 'https://raw.githubusercontent.com/morning-start/silk/HEAD/CHANGELOG.md' | Convert-MarkdownToHtml
