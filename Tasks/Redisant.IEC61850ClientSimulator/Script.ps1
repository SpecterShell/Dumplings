$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/chenjing1294/iec61850-client-simulator-release/releases/latest"
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.redisant.com/iec61850client/download' | ConvertFrom-Html
    ...
    try {
      $Object3 = Invoke-WebRequest -Uri 'https://www.redisant.cn/iec61850client/download' | ConvertFrom-Html
