...
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x86'
  InstallerUrl = "https://www.megasoftware.net/releases/MEGA_CC_$($this.CurrentState.Version)_win32_setup.exe"
}
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x64'
  InstallerUrl = "https://www.megasoftware.net/releases/MEGA_CC_$($this.CurrentState.Version)_win64_setup.exe"
}
