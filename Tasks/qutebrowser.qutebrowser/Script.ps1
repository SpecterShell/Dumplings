$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/qutebrowser/qutebrowser/releases/latest"
  ...
  'New|Changed|Updated' {
    ...
    try {
      ...
      $this.CurrentState.Locale += [ordered]@{
        Key   = 'ReleaseNotesUrl'
        Value = $ReleaseNotesUrl = 'https://www.qutebrowser.org/doc/changelog.html'
      }
