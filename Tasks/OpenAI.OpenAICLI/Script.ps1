$Object1 = Invoke-GitHubApi -Uri 'https://api.github.com/repos/openai/openai-cli/releases/latest'
...
$this.CurrentState.Installer += [ordered]@{
  ...
  InstallerUrl        = $Object1.assets.Where({ $_.name.EndsWith('.zip') -and $_.name.Contains('386') -and $_.name -match 'windows' }, 'First')[0].browser_download_url | ConvertTo-UnescapedUri
}
$this.CurrentState.Installer += [ordered]@{
  Architecture        = 'x64'
  InstallerType       = 'zip'
