$Object1 = Invoke-WebRequest -Uri 'https://www.altova.com/thankyou?ProductCode=TD&EditionCode=Z&InstallerType=Product&Lang=en&OperatingSystem=win32'
  ...
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.altova.com/releasenotes/getnotes' -Method Post -Body @{
        category = 'mobile'
        product  = 'MobileTogetherDesigner'
