function Read-Installer {
  ...
  # Version
  $this.CurrentState.Version = ($InstallerFile | Read-ProductVersionFromExe) -replace '^v'
  # InstallerSha256
...
function Get-ReleaseNotes {
  try {
    $Object2 = Invoke-WebRequest -Uri 'https://www.sharemouse.com/download/changelog/' | ConvertFrom-Html
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = 'https://www.sharemouse.com/ShareMouseSetup.exe'
}
