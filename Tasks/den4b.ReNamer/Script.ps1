$Object1 = Invoke-WebRequest -Uri 'https://www.den4b.com/changelogs/renamer' | ConvertFrom-Html
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = "https://www.den4b.com/download/renamer/installer/$($this.CurrentState.Version)?token=winget"
}
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      $Object2 = (Invoke-RestMethod -Uri 'https://www.den4b.com/news.atom').Where({ $_.title.Contains('ReNamer') -and $_.title.Contains($this.CurrentState.Version) }, 'First')
