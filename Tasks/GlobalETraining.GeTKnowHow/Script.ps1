function Read-Installer {
  ...
  # Version
  $this.CurrentState.Version = (Get-MsiInstallerInfo -Path $InstallerFile).DisplayVersion
...
$this.CurrentState.Installer += [ordered]@{
  Architecture  = 'x64'
  InstallerType = 'msi'
  InstallerUrl  = 'https://getplugins.blob.core.windows.net/plugin-download/GeT%20Know-How%20Setup.msi'
}
...
if ($Global:DumplingsPreference.Contains('Force') -and $Global:DumplingsPreference.Force) {
