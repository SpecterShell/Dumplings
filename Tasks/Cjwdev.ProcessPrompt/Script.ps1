function Read-Installer {
  ...
  7z.exe e -aoa -ba -bd -y -o"${InstallerFileExtracted}" $InstallerFile 'ProcessPrompt.exe' | Out-Host
  $InstallerFile2 = Join-Path $InstallerFileExtracted 'ProcessPrompt.exe'
  ...
  $InstallerFile3 = Join-Path $InstallerFile2Extracted 'ProcessPrompt.msi'
  $InstallerFile4 = Join-Path $InstallerFile2Extracted 'ProcessPrompt.x64.msi'
  # Version
...
function Get-ReleaseNotes {
  try {
    $Object3 = Invoke-RestMethod -Uri 'https://cjwdev.com/Software/ProcPrompt/LatestVersion.xml'
...
$Prefix = 'https://cjwdev.com/Software/ProcPrompt/Download.html'
