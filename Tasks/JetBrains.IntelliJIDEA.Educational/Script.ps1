$Object1 = $Global:DumplingsStorage.JetBrainsApps.IIE.release
...
$this.CurrentState.Installer += $InstallerX64 = [ordered]@{
  ...
  ProductCode            = "IntelliJ IDEA Educational Edition $($this.CurrentState.Version)"
  AppsAndFeaturesEntries = @(
    [ordered]@{
      DisplayName    = "IntelliJ IDEA Educational Edition $($this.CurrentState.Version)"
