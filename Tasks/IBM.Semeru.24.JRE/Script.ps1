$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/ibmruntimes/semeru24-binaries/releases/latest"
...
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x64'
  InstallerUrl = $Object1.assets.Where({ $_.name.EndsWith('.msi') -and $_.name -match 'jre' }, 'First').browser_download_url | ConvertTo-UnescapedUri
}
