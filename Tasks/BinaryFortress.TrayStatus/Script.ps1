$Object1 = Invoke-RestMethod -Uri 'https://api.binaryfortress.com/UpdateCheck/' -Method Post -Headers @{'BFAPI-TargetProductID' = '114' } -Body (
  @{
    cpu = 64
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.traystatus.com/ChangeLog/' | ConvertFrom-Html
