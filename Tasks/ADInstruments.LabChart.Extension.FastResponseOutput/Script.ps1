...
$Object1 = $Global:DumplingsStorage.ADInstrumentsApps.Where({ $_.ID -eq 'FastResponseOutput' }, 'First')[0]
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.adinstruments.com/support/downloads/windows/fast-response-output' | ConvertFrom-Html
