...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = Join-Uri 'https://pohlcon.com/fileadmin/crossbase/SOF/PRO/' $Global:DumplingsStorage.PohlConDownloadPage.SelectSingleNode('//li[@data-cbid="10799"]//option[contains(text(), "EN")]').Attributes['value'].Value
}
