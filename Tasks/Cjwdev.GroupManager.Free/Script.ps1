function Read-Installer {
  ...
  $InstallerFileExtracted = Expand-TempArchive -Path $InstallerFile -RelativeFilePath 'GroupManagerFreeSetup.exe' -CollisionAction Rename
  try {
    # Version
...
function Get-ReleaseNotes {
  try {
    $Object2 = [System.IO.StreamReader]::new((Invoke-WebRequest -Uri 'https://cjwdev.com/Software/GroupMan/VersionHistory.txt').RawContentStream)
