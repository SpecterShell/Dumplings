function Read-Installer {
  ...
  try {
    # Version
    $this.CurrentState.Version = (Get-AdvancedInstallerMsiInfo -Path (Join-Path $InstallerFileExtracted 'NtfsPermissionsReporterInstaller.exe') -Architecture x64).ProductVersion
  } finally {
