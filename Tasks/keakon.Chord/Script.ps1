$Object1 = Invoke-GitHubApi -Uri 'https://api.github.com/repos/keakon/chord/releases/latest'
...
$this.CurrentState.Installer += [ordered]@{
  ...
  NestedInstallerFiles = @([ordered]@{ RelativeFilePath = "$($Asset.name | Split-Path -LeafBase)\chord.exe" })
