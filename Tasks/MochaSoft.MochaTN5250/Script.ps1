...
function Get-ReleaseNotes {
  try {
    $Object2 = Invoke-WebRequest -Uri 'https://www.mochasoft.dk/tn5250_release.htm' | ConvertFrom-Html

    $ReleaseNotesTitleNode = $Object2.SelectSingleNode("//b[contains(text(), 'version $($this.CurrentState.Version)')]")
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = 'https://www.mochasoft.dk/tn5250.msi'
}
