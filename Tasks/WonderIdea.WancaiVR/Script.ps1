# x86
$Object1 = Invoke-RestMethod -Uri 'https://www.animiz.cn/webapis/appupdate/client-latest?app=wancaivr&digit=32'

# x64
$Object2 = Invoke-RestMethod -Uri 'https://www.animiz.cn/webapis/appupdate/client-latest?app=wancaivr&digit=64'
