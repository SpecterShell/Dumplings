...
$Object1 = Invoke-WebRequest -Uri 'https://apps.docman.com/'

$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Object1.Links.Where({ try { $_.href.EndsWith('.msi') -and $_.href -match 'Migration[^a-zA-Z]+Agent' -and $_.href.Contains('sco') } catch {} }, 'First')[0].href | ConvertTo-UnescapedUri
}
