$Object1 = Invoke-WebRequest -Uri 'https://www.esbconsult.com/esbcalc/esbunitconvpro.htm'
...
# Version
$this.CurrentState.Version = [regex]::Match($Object1.Content, 'ESBUnitConv&trade; Pro Trial v(\d+(?:\.\d+)+)').Groups[1].Value
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    $InstallerFile2 = $InstallerFile | Expand-TempArchive -CollisionAction Rename | Join-Path -ChildPath 'esbunitconv_setup.exe'
    # RealVersion
