$Object1 = Invoke-WebRequest -Uri 'https://www.esbconsult.com/esbcalc/esbcalc.htm'
...
# Version
$this.CurrentState.Version = [regex]::Match($Object1.Content, 'ESBCalc&trade; v(\d+(?:\.\d+)+)').Groups[1].Value
