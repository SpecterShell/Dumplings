...
$Object1 = Invoke-WebRequest -Uri 'https://worksheetcrafter.com/de/downloads/testversion'
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Object1.Links.Where({ $_.outerHTML.Contains('Download Windows') }, 'First')[0].href
}
