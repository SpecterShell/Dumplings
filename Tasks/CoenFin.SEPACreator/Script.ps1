...
function Get-ReleaseNotes {
  try {
    $Object3 = Invoke-RestMethod -Uri 'https://coenfin.nl/wp-admin/admin-ajax.php?action=get_wdtable&table_id=4' -Method Post -Body @{
      draw               = '1'
      'columns[0][data]' = '0'
      ...
      start              = '0'
      length             = '5'
      wdtNonce           = ($Object1 | ConvertFrom-Html).SelectSingleNode("//input[@name='wdtNonceFrontendServerSide_4']").Attributes['value'].Value
    }
...
$Object1 = Invoke-WebRequest -Uri 'https://coenfin.nl/sepa-creator/'
