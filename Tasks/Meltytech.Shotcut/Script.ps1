$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/mltframework/shotcut/releases/latest"
...
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'arm64'
  InstallerUrl = $Object1.assets.Where({ $_.name.EndsWith('.exe') -and $_.name.Contains('win_ARM') }, 'First')[0].browser_download_url | ConvertTo-UnescapedUri
}
