...
# Version
$this.CurrentState.Version = $Object1.customtableitem_org_ReReplacers[0].org_ReReplacer.Where({ $_.Search -eq '{{latest-virtserver-version-title-build}}' }, 'First')[0].Replace
