$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/qier222/YesPlayMusic/releases/latest"
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    $Object2 = Invoke-RestMethod -Uri $Object1.assets.Where({ $_.name -eq 'latest.yml' }, 'First')[0].browser_download_url | ConvertFrom-Yaml
