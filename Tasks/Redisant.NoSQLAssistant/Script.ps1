$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/chenjing1294/nosql-assistant-release/releases/latest"
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.redisant.com/nosql/download' | ConvertFrom-Html
    ...
    try {
      $Object3 = Invoke-WebRequest -Uri 'https://www.redisant.cn/nosql/download' | ConvertFrom-Html
