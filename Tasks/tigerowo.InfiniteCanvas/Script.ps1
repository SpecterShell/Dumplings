$Object1 = Invoke-GitHubApi -Uri 'https://api.github.com/repos/tigerowo/infinite-canvas/releases/latest'
...
$this.CurrentState.Installer += [ordered]@{
  ...
  Architecture    = 'x64'
  InstallerType   = 'wix'
  InstallerUrl    = $Object1.assets.Where({ $_.name.EndsWith('.msi') -and $_.name.Contains('x64') -and $_.name.Contains('zh-CN') }, 'First')[0].browser_download_url | ConvertTo-UnescapedUri
}
