function Read-Installer {
  ...
  7z.exe e -aoa -ba -bd -y -o"${InstallerFileExtracted}" $InstallerFile 'Three Ships Helper.msi' | Out-Host
  $InstallerFile2 = Join-Path $InstallerFileExtracted 'Three Ships Helper.msi'
  # Version
...
$Prefix = 'https://www.threeships.nl/Plugin/ThreeShipsHelper.htm'
