$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/fleetdm/fleet/releases/latest"
...
$this.CurrentState.Installer += [ordered]@{
  Architecture         = 'x64'
  InstallerUrl         = $Object1.assets.Where({ $_.name.EndsWith('.zip') -and $_.name -match 'windows' -and -not $_.name.Contains('arm64') }, 'First')[0].browser_download_url | ConvertTo-UnescapedUri
