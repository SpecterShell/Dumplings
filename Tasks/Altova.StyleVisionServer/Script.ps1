...
$Object1 = Invoke-WebRequest -Uri 'https://www.altova.com/thankyou?ProductCode=SS&EditionCode=Z&InstallerType=Product&Lang=multi&OperatingSystem=win32'
