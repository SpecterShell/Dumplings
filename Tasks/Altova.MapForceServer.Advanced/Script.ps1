...
$Object1 = Invoke-WebRequest -Uri 'https://www.altova.com/thankyou?ProductCode=MS&EditionCode=A&InstallerType=Product&Lang=multi&OperatingSystem=win32'
