...
$Object1 = $Global:DumplingsStorage.ADInstrumentsApps.Where({ $_.ID -eq 'NICO' }, 'First')[0]
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.adinstruments.com/support/downloads/windows/non-invasive-cardiac-output' | ConvertFrom-Html
