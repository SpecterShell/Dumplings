...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = (Invoke-RestMethod -Uri 'https://www.qnap.com/api/v1/release-notes/utility/QuDedup%20Extract%20Tool?locale=en').result.notes.Windows.Where({ $_.version -eq $Object1.version }, 'First')
    ...
    try {
      $Object3 = (Invoke-RestMethod -Uri 'https://www.qnap.com/api/v1/release-notes/utility/QuDedup%20Extract%20Tool?locale=zh-cn').result.notes.Windows.Where({ $_.version -eq $Object1.version }, 'First')
