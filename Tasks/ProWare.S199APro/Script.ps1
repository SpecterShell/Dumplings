$Object1 = Invoke-WebRequest -Uri 'https://www.proware-cpa.biz/demos/s199apro/index.html' | ConvertFrom-Html
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    $InstallerFile2 = Expand-InnoInstaller -Path $InstallerFile -DestinationPath $InstallerFileExtracted -Name 's199apro.exe'
    # RealVersion
