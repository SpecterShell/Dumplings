...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    #   $ReleaseNotesUrl = $Object1.Links.Where({ try { $_.href.Contains('release-notes') -and $_.href.Contains('2025') } catch {} }, 'First')[0].href
    ...
    #     }
    #   } else {
    #     $PossibleReleaseNotesUrls = $Object2.Links.Where({ try { $_.href.Contains('release-notes') -and $_.href.Contains('2025') } catch {} })
