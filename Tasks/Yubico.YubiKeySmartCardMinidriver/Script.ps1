...
# Installer
$Link = $Object1.Links.Where({ try { $_.href.Contains('Minidriver') -and $_.href.EndsWith('.msi') -and $_.href.Contains('x86') } catch {} }, 'First')[0]
...
$Link = $Object1.Links.Where({ try { $_.href.Contains('Minidriver') -and $_.href.EndsWith('.msi') -and $_.href.Contains('x64') } catch {} }, 'First')[0]
...
# $Link = $Object1.Links.Where({ try { $_.href.Contains('Minidriver') -and $_.href.EndsWith('.msi') -and $_.href.Contains('arm64') } catch {} }, 'First')[0]
