...
$Task.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Prefix + $Object.SelectSingleNode('//*[@id="WIN_CLIENT_LINK"]').Attributes['href'].Value
}
$Task.CurrentState.Installer += [ordered]@{
  InstallerLocale = 'zh-CN'
  InstallerUrl    = $Object.SelectSingleNode('//*[@id="WIN_CLIENT_LINK2"]').Attributes['href'].Value
}

$ReleaseNotesTitleNode = $Object.SelectNodes("//*[@id='page-top']/table/tbody/tr/td[2]/table/tbody/tr/td/h4[starts-with(./text(), 'AirGamePlayer')]") |
