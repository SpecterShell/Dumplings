...
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x86'
  InstallerUrl = $InstallerUrlX86 = Get-RedirectedUrl1st -Uri 'https://bff-pc.qishui.com/light/invoke/download?os=win32&arch=ia32' -Method GET
}
...
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x64'
  InstallerUrl = $InstallerUrlX64 = Get-RedirectedUrl1st -Uri 'https://bff-pc.qishui.com/light/invoke/download?os=win32&arch=x64' -Method GET
}
