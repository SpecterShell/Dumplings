$ProjectName = 'sweethome3d'
$RootPath = '/SweetHome3D'
$PatternPath = '.+'
$PatternFilename = 'SweetHome3D-(\d+(?:\.\d+)+)-windows\.exe'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.sweethome3d.com/history.jsp' | ConvertFrom-Html
