...
function Get-ReleaseTime {
  try {
    # ReleaseTime
    $this.CurrentState.ReleaseTime = [DateTime]::ParseExact($Object1.'release-version', 'yyyyMMddHHmmss', $null).ToString('yyyy-MM-dd')
  } catch {
    $_ | Out-Host
    $this.Log($_, 'Warning')
  }
...
$Object1 = Invoke-RestMethod -Uri 'https://dl.appstreaming.autodesk.com/production/67316f5e79bc48318aa5f7b6bb58243d/73e72ada57b7480280f7a6f4a289729f/full.json'

# Version
$this.CurrentState.Version = $Object1.'build-version'

# Installer
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $InstallerUrl = 'https://dl.appstreaming.autodesk.com/production/installers/Fusion%20Client%20Downloader.exe'
}
