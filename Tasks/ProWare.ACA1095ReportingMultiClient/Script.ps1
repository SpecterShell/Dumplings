$Object1 = Invoke-WebRequest -Uri 'https://www.proware-cpa.biz/demos/acamc/index.html' | ConvertFrom-Html
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    $InstallerFile2 = Expand-InnoInstaller -Path $InstallerFile -DestinationPath $InstallerFileExtracted -Name 'ACAMC.exe'
    # RealVersion
