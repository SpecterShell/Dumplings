$Object1 = curl -fsSLA $DumplingsInternetExplorerUserAgent 'https://support.freedomscientific.com/Downloads/OfflineInstallers/GetInstallers?product=JAWS&version=27&language=mul&releaseType=Offline' | Join-String -Separator "`n" | ConvertFrom-Json
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    $Object2 = curl -fsSLA $DumplingsInternetExplorerUserAgent 'https://support.freedomscientific.com/Downloads/JAWS/PreviousFeatures?version=2026' | Join-String -Separator "`n" | ConvertFrom-Html
