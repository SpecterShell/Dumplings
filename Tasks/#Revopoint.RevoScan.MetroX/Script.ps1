...
if (Test-Path -Path $OldReleasesPath) {
  $Global:DumplingsStorage['RevoScanMetroX'] = $OldReleases = Get-Content -Path $OldReleasesPath -Raw | ConvertFrom-Yaml -Ordered
} else {
  $Global:DumplingsStorage['RevoScanMetroX'] = $OldReleases = [ordered]@{}
}
