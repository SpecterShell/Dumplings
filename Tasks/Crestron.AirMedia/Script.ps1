$Object1 = Invoke-WebRequest -Uri 'https://crestronairmedia.blob.core.windows.net/blob/packages/win/released/RELEASES' | Read-ResponseContent | ConvertFrom-SquirrelReleases | Where-Object -FilterScript { -not $_.IsDelta } | Sort-Object -Property { [ChunkVersion]($_.Version) } -Bottom 1
