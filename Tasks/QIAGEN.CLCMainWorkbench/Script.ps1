...
#   product         = 'CLC Main Workbench'
#   platform        = 'windows'
#   platformVersion = '10.0'
#   platformArch    = 'amd64'
# }

$Object1 = Invoke-WebRequest -Uri 'https://digitalinsights.qiagen.com/products/clc-main-workbench-direct-download/'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://digitalinsights.qiagen.com/products/qiagen-clc-main-workbench/latest-improvements/current-line/' | ConvertFrom-Html
