...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = Get-RedirectedUrls -Uri 'https://lb3.pcvisit.de/v1/hosted/jumplink?func=download&topic=remoteHostSetup&destname=pcvisit_Remote-Host_Setup&os=osWin32' -Method GET | Select-Object -Last 1
}
