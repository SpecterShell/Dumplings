$Object1 = Invoke-WebRequest -Uri 'https://www.youxiao.cn/yxfile/' | ConvertFrom-Html
...
$Task.CurrentState.Installer += [ordered]@{
  InstallerUrl = "https://static.youxiao.cn/yxfile/yxfile_v$($Task.CurrentState.Version).exe"
}

switch (Compare-State) {
  ({ $_ -ge 1 }) {
    $Object2 = Invoke-WebRequest -Uri 'https://www.youxiao.cn/index.php/yxfile/log/' | ConvertFrom-Html

    try {
      $ReleaseNotesTitleNode = $Object2.SelectSingleNode("//*[@id='post-930']/div[2]/ul[contains(./li/text(), '$($Task.CurrentState.Version)')]")
