function Read-Installer {
  ...
  7z.exe e -aoa -ba -bd -y -o"${InstallerFileExtracted}" $InstallerFile 'ADPhotoEditSetup.msi' | Out-Host
  $InstallerFile2 = Join-Path $InstallerFileExtracted 'ADPhotoEditSetup.msi'
  # Version
...
function Get-ReleaseNotes {
  try {
    $Object2 = [System.IO.StreamReader]::new((Invoke-WebRequest -Uri 'https://cjwdev.com/Software/ADPhotoEdit/VersionHistory.txt').RawContentStream)
...
$Prefix = 'https://cjwdev.com/Software/ADPhotoEdit/Bulk/TrialDownload.html'
