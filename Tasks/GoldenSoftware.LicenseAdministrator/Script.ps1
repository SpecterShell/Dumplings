...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Global:DumplingsStorage.GoldenSoftwareDownloadPage.Links.Where({ try { $_.href.EndsWith('.exe') -and $_.href.Contains('License_Administrator') } catch {} }, 'First')[0].href
}
