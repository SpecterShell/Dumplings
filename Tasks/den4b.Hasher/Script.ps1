$Object1 = Invoke-WebRequest -Uri 'https://www.den4b.com/changelogs/hasher' | ConvertFrom-Html
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = "https://www.den4b.com/download/hasher/installer/$($this.CurrentState.Version)?token=winget"
}
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      $Object2 = (Invoke-RestMethod -Uri 'https://www.den4b.com/news.atom').Where({ $_.title.Contains('Hasher') -and $_.title.Contains($this.CurrentState.Version) }, 'First')
