...
$this.CurrentState.Version = [regex]::Match(
  $Object1.SelectSingleNode('//*[@id="SERVER_VER"]').InnerText,
  '\((.+)\)'
).Groups[1].Value

# Installer
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Prefix + $Object1.SelectSingleNode('//*[@id="SERVER_LINK"]').Attributes['href'].Value
}
$this.CurrentState.Installer += [ordered]@{
...
$ReleaseNotesTitleNode = $Object1.SelectNodes("//*[@id='page-top']/table/tbody/tr/td[2]/table/tbody/tr/td/h4[starts-with(./text(), 'AirGame')]") |
