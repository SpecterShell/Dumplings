...
$Object1 = Invoke-WebRequest -Uri 'https://www.altova.com/thankyou?ProductCode=RS&EditionCode=M&InstallerType=Product&Lang=multi&OperatingSystem=win32'
