$Object1 = Invoke-RestMethod -Uri 'https://updates-api.picotech.com/api/v3/Releases/PicoLog/PicoLog?Os=Windows&Architecture=AMD64&EnableBetaVersions=False&GetLatestVersion=True'
