$Object1 = Invoke-GitHubApi -Uri 'https://api.github.com/repos/WHStudio/InspireMusic/releases/latest'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      ...
      if (-not [string]::IsNullOrWhiteSpace($Object1.body) -and $Object1.body -notmatch 'See the assets to download this version and install') {
        # ReleaseNotes (zh-CN)
