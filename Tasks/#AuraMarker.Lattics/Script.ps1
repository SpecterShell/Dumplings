...
if (Test-Path -Path $OldReleaseNotesPath) {
  $Global:LocalStorage['Lattics'] = $OldReleaseNotes = Get-Content -Path $OldReleaseNotesPath -Raw | ConvertFrom-Yaml -Ordered
} else {
  $Global:LocalStorage['Lattics'] = $OldReleaseNotes = [ordered]@{}
}
