$Object1 = Invoke-WebRequest -Uri 'https://download.catlight.io/rel/win/beta/RELEASES' | Read-ResponseContent | ConvertFrom-SquirrelReleases | Where-Object -FilterScript { -not $_.IsDelta } | Sort-Object -Property { [ChunkVersion]($_.Version) } -Bottom 1
