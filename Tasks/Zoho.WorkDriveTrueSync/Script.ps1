...
$EdgeDriver.Navigate().GoToUrl('https://www.zoho.com/workdrive/truesync.html')

$EdgeDriver.ExecuteScript('document.querySelector("label.sign_agree").dispatchEvent(new Event("change"))')

# Installer
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $EdgeDriver.FindElement([OpenQA.Selenium.By]::XPath('//a[contains(@class, "btn-download")]')).GetAttribute('href')
}
