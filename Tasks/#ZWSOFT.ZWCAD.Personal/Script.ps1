...
if (Test-Path -Path $OldReleasesPath) {
  $Global:DumplingsStorage['ZWCADPersonal'] = $OldReleases = Get-Content -Path $OldReleasesPath -Raw | ConvertFrom-Yaml -Ordered
} else {
  $Global:DumplingsStorage['ZWCADPersonal'] = $OldReleases = [ordered]@{}
}
