...
if (Test-Path -Path $OldReleaseNotesPath) {
  $Global:LocalStorage['HiSuite'] = $OldReleaseNotes = Get-Content -Path $OldReleaseNotesPath -Raw | ConvertFrom-Yaml -Ordered
} else {
  $Global:LocalStorage['HiSuite'] = $OldReleaseNotes = [ordered]@{}
}
