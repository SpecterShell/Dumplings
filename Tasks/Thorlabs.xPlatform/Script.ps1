$Object1 = Invoke-WebRequest -Uri 'https://www.thorlabs.com/software_pages/check_updates.cfm?ItemID=MCLS2-CUSTOM' | Read-ResponseContent | ConvertFrom-Xml
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    foreach ($Installer in $this.CurrentState.Installer) {
      ...
      $InstallerFile3 = Join-Path $InstallerFile2Extracted 'xPlatform.msi'
      # RealVersion
