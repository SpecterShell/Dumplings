...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = Get-RedirectedUrl -Uri 'https://cloud.pix4d.com/download_release/pix4dmatic/latest/windows'
}
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://support.pix4d.com/hc/en-us/articles/360044709531' | ConvertFrom-Html

      $ReleaseNotesTitleNode = $Object2.SelectSingleNode("//table[contains(./tbody/tr[2]/td[1]/text(), '$($this.CurrentState.Version)')]")
