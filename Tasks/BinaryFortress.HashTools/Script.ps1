$Object1 = Invoke-RestMethod -Uri 'https://api.binaryfortress.com/UpdateCheck/' -Method Post -Headers @{'BFAPI-TargetProductID' = '109' } -Body (
  @{
    cpu = 64
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.binaryfortress.com/HashTools/ChangeLog/' | ConvertFrom-Html
