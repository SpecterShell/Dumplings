function Read-Installer {
  ...
  7z.exe e -aoa -ba -bd -y -o"${InstallerFileExtracted}" $InstallerFile 'LinkrUI.exe' | Out-Host
  $InstallerFile2 = Join-Path $InstallerFileExtracted 'LinkrUI.exe'
  # Version
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = 'https://cdn.linkrui.com/installers/current/windows/universal/LinkrUI.zip'
}
