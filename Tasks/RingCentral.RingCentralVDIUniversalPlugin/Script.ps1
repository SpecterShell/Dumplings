$Uri1 = 'https://app.ringcentral.com/download/vdi/RingCentral-App-VdiUniversalPlugin.msi'
...
if ($Global:DumplingsPreference.Contains('Force')) {
  ...
  try {
    $Uri2 = "https://app.ringcentral.com/download/vdi/RingCentral-App-VdiUniversalPlugin-$($this.CurrentState.Version).msi"
