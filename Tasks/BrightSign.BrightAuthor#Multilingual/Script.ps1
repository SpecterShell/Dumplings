...
# Version
$this.CurrentState.Version = $Object1.general.'bac-multi'.version

# Installer
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Object1.general.'bac-multi'.link
}
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      # ReleaseTime
      $this.CurrentState.ReleaseTime = $Object1.general.'bac-multi'.'release-date' | Get-Date -Format 'yyyy-MM-dd'

      # ReleaseNotesUrl
      $this.CurrentState.Locale += [ordered]@{
        Key   = 'ReleaseNotesUrl'
        Value = $Object1.general.'bac-multi'.'release-notes'
      }
