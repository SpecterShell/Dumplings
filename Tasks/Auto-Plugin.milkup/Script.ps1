$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/Auto-Plugin/milkup/releases/latest"

# Version
$this.CurrentState.Version = $Object1.tag_name -replace '^Beta-v' -replace '^v'
