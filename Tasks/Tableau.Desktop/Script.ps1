...
$Object1 = Invoke-WebRequest -Uri 'https://www.tableau.com/support/releases/desktop/latest' -UserAgent $UserAgent
# ReleaseNotesUrl
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object5 = Invoke-WebRequest -Uri 'https://www.tableau.com/zh-cn/support/releases/desktop/latest' -UserAgent $UserAgent
