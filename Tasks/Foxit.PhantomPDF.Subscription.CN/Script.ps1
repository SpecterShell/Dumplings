# EXE (Burn)
$Object1 = Invoke-RestMethod -Uri 'https://www.foxitsoftware.cn/portal/download/getpackage.html?product=Foxit-PhantomPDF-Business-2023&language=Chinese&platform=32-bit&package_type=exe'
# MSI (WiX)
$Object2 = Invoke-RestMethod -Uri 'https://www.foxitsoftware.cn/portal/download/getpackage.html?product=Foxit-PhantomPDF-Business-2023&language=Chinese&platform=32-bit&package_type=msi'
