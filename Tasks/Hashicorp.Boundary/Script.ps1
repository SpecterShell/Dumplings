...
$FolderName = $Object1.Links.Where({ try { $_.href -match '^/boundary/\d+(?:\.\d+)+/$' } catch {} }).href | Sort-Object -Property { [ChunkVersion]($_) } -Bottom 1
  ...
  'New|Changed|Updated' {
    try {
      ...
      $this.CurrentState.Locale += [ordered]@{
        Key   = 'ReleaseNotesUrl'
        Value = "https://github.com/hashicorp/boundary/releases"
      }

      $Object2 = Invoke-GitHubApi -Uri "https://api.github.com/repos/hashicorp/boundary/releases/tags/v$($this.CurrentState.Version)"
