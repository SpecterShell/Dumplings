$Prefix = 'https://cdn.kde.org/ci-builds/games/klickety/master/windows/'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    $this.CurrentState.RealVersion = Get-ItemPropertyValue -Path 'HKLM:\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\klickety' -Name 'DisplayVersion'
