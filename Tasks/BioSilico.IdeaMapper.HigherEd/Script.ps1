...
$Object1 = Invoke-RestMethod -Uri 'https://update.ideamapper.com/cgi-bin/updateinfo.cgi' -Body @{
  program    = 'IdeaMapperHigherEd'
  os         = 'win32'
  serialno   = '0'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    foreach ($Installer in $this.CurrentState.Installer) {
      ...
      $InstallerFile2 = Join-Path $InstallerFileExtracted 'Idea Mapper Higher Ed.msi'
      # ProductCode
