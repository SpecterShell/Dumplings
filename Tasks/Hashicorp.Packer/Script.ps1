$Prefix = 'https://releases.hashicorp.com/packer/'
$Object1 = Invoke-WebRequest -Uri $Prefix

$FolderName = $Object1.Links.Where({ try { $_.href -match '^/packer/\d+(?:\.\d+)+/$' } catch {} }).href | Sort-Object -Property { [ChunkVersion]($_) } -Bottom 1
  ...
  'New|Changed|Updated' {
    try {
      ...
      $this.CurrentState.Locale += [ordered]@{
        Key   = 'ReleaseNotesUrl'
        Value = "https://github.com/hashicorp/packer/releases"
      }

      $Object2 = Invoke-GitHubApi -Uri "https://api.github.com/repos/hashicorp/packer/releases/tags/v$($this.CurrentState.Version)"
