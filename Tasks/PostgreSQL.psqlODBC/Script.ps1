$Object1 = (Invoke-GitHubApi -Uri "https://api.github.com/repos/postgresql-interfaces/psqlodbc/releases").Where({ $_.prerelease -eq $false -and -not $_.tag_name.Contains('mimalloc') }, 'First')[0]
