$Object1 = Invoke-GitHubApi -Uri 'https://api.github.com/repos/beyondtranslate/beyondtranslate-ce/releases/latest'
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $InstallerUrl = $Object1.assets.Where({ $_.name.EndsWith('.exe') -and $_.name -match 'windows' -and $_.name -match 'setup' }, 'First')[0].browser_download_url | ConvertTo-UnescapedUri
}
