$Object1 = Invoke-GitHubApi -Uri 'https://api.github.com/repos/QingJ01/Clyde/releases/latest'
  ...
  'New|Changed|Updated' {
    ...
    try {
      ...
      $this.CurrentState.Locale += [ordered]@{
        Locale = 'en-US'
        Key    = 'ReleaseNotesUrl'
        Value  = $ReleaseNotesUrl = 'https://github.com/QingJ01/Clyde/blob/HEAD/CHANGELOG.md'
      }

      $Object2 = Invoke-RestMethod -Uri 'https://raw.githubusercontent.com/QingJ01/Clyde/HEAD/CHANGELOG.md' | Convert-MarkdownToHtml
