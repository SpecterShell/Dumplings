$Object1 = (Invoke-GitHubApi -Uri 'https://api.github.com/repos/esengine/DeepSeek-Reasonix/releases').Where({ -not $_.prerelease -and -not $_.tag_name.StartsWith('desktop-v') }, 'First')[0]
