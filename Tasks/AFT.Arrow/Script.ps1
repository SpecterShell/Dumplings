...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = 'https://www.aft.com/aftproducts/AroFullz.exe'
}
...
switch -Regex ($this.Check()) {
  ...
  'Updated|Rollbacked' {
    ...
    if ($this.CurrentState.Version.Split('.')[0] -ne $this.LastState.Version.Split('.')[0]) {
      $this.Config.RemoveLastVersion = $false
      $this.Log('Major version update. The old version needs to be updated to a fixed installer URL', 'Error')
    }
    $this.Submit()
  }
