$Prefix = 'https://builds.opentrons.com/app/'
  ...
  'New|Changed|Updated' {
    ...
    try {
      ...
      $this.CurrentState.Locale += [ordered]@{
        Locale = 'en-US'
        Key    = 'ReleaseNotesUrl'
        Value  = $ReleaseNotesUrl = 'https://github.com/Opentrons/opentrons/blob/HEAD/app-shell/build/release-notes.md'
      }

      $Object2 = Invoke-RestMethod -Uri 'https://raw.githubusercontent.com/Opentrons/opentrons/HEAD/app-shell/build/release-notes.md' | Convert-MarkdownToHtml
