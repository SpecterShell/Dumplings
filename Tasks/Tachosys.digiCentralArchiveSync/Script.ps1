$Object1 = Invoke-WebRequest -Uri 'https://tachosys.com/Product/digiCentralArchiveSync'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    foreach ($Installer in $this.CurrentState.Installer) {
      ...
      $InstallerFile2 = Join-Path $InstallerFileExtracted 'digiCentral Archive Sync.msi'
      # ProductCode
