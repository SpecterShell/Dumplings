$Object1 = Invoke-RestMethod -Uri "https://update.backyard.ai/update/win32/$($this.LastState.Contains('Version') ? $this.LastState.Version : '0.29.0')" -StatusCodeVariable 'StatusCode'
