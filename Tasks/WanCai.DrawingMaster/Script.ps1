# x64
$Object1 = Invoke-RestMethod -Uri 'https://drawingmaster.wmindmap.cn/download/client-update?digit=64'

# x86
$Object2 = Invoke-RestMethod -Uri 'https://drawingmaster.wmindmap.cn/download/client-update?digit=32'
