$Object1 = $Global:DumplingsStorage.DellPrecedenceCatalog | Select-Xml -XPath '/dm:Precedence/dm:Demoted/dm:SoftwareComponent[./dm:SupportedDevices/dm:Device/@componentID="107174"]' -Namespace @{ dm = $Global:DumplingsStorage.DellPrecedenceCatalog.Precedence.xmlns } | Select-Object -ExpandProperty 'Node' -Last 1
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    $InstallerX64Info = Get-InstallShieldMsiInfo -Path $InstallerX64File2 -Name 'DellCommandUpdateApp.msi'
