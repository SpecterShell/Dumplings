...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Object1.Links.Where({ try { $_.href.EndsWith('.msi') -and $_.href.Contains('Migration%20Agent') -and $_.href.Contains('eng') } catch {} }, 'First')[0].href | ConvertTo-UnescapedUri
}
