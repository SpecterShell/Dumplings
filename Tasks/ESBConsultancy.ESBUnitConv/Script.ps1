$Object1 = Invoke-WebRequest -Uri 'https://www.esbconsult.com/esbcalc/esbunitconv.htm'
...
# Version
$this.CurrentState.Version = [regex]::Match($Object1.Content, 'ESBUnitConv&trade; v(\d+(?:\.\d+)+)').Groups[1].Value
