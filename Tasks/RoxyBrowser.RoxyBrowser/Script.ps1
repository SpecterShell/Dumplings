# x86 en-US
$Object1 = Invoke-RestMethod -Uri 'https://us.gate.roxybrowser.net/get_app_upgrade' -Method Post -Headers @{ appVersion = $this.Status.Contains('New') ? '3.7.5' : $this.LastState.Version; language = 'en-US' } -Body (
  $Body = @{
    os        = 'win32'
    osVersion = '10'
    cpu       = 'intel'
...
# x86 zh-CN
$Object2 = Invoke-RestMethod -Uri 'https://us.gate.roxybrowser.net/get_app_upgrade' -Method Post -Headers @{ appVersion = $this.Status.Contains('New') ? '3.7.5' : $this.LastState.Version; language = 'zh-CN' } -Body $Body -ContentType 'application/json'
# x64 en-US
$Object3 = Invoke-RestMethod -Uri 'https://us.gate.roxybrowser.net/get_app_upgrade' -Method Post -Headers @{ appVersion = $this.Status.Contains('New') ? '3.7.5' : $this.LastState.Version; language = 'en-US' } -Body (
  $Body = @{
    os        = 'win32'
    osVersion = '10'
    cpu       = 'intel'
...
# x64 zh-CN
$Object4 = Invoke-RestMethod -Uri 'https://us.gate.roxybrowser.net/get_app_upgrade' -Method Post -Headers @{ appVersion = $this.Status.Contains('New') ? '3.7.5' : $this.LastState.Version; language = 'zh-CN' } -Body $Body -ContentType 'application/json'
