...
$Object1 = Invoke-WebRequest -Uri 'https://www.altova.com/thankyou?ProductCode=RS&EditionCode=L&InstallerType=Product&Lang=multi&OperatingSystem=win32'
