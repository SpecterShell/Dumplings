$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/wasmerio/wasmer/releases/latest"
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Object1.assets.Where({ $_.name.EndsWith('.exe') -and $_.name -match 'windows' }, 'First')[0].browser_download_url | ConvertTo-UnescapedUri
}
  ...
  'New|Changed|Updated' {
    ...
    try {
      ...
      $this.CurrentState.Locale += [ordered]@{
        Key   = 'ReleaseNotesUrl'
        Value = $ReleaseNotesUrl = "https://github.com/wasmerio/wasmer/blob/master/CHANGELOG.md"
      }

      $Object2 = Invoke-RestMethod -Uri "https://raw.githubusercontent.com/wasmerio/wasmer/master/CHANGELOG.md" | Convert-MarkdownToHtml
