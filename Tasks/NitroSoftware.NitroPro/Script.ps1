$Object1 = Invoke-RestMethod -Uri 'https://downloads.gonitro.com/rss_feed/windows/14/retail/pro.rss'
...
$this.CurrentState.Installer += [ordered]@{
  InstallerType = 'wix'
  InstallerUrl  = "https://downloads.gonitro.com/professional_$($this.CurrentState.Version)/en/retail/nitro_pro14_ba_x64.msi"
}
