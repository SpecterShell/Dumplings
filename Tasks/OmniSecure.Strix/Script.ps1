$Object1 = Invoke-GitHubApi -Uri 'https://api.github.com/repos/usestrix/strix/releases/latest'
...
$this.CurrentState.Installer += [ordered]@{
  ...
  NestedInstallerFiles = @([ordered]@{ RelativeFilePath = "$($Asset.name | Split-Path -LeafBase).exe"; PortableCommandAlias = 'strix' })
}
