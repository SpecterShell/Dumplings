$Object1 = Invoke-WebRequest -Uri 'https://www.dragonframe.com/downloads/'

# Installer
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Object1.Links.Where({ try { $_.href.EndsWith('.exe') -and $_.href.Contains('DragonframeLicenseManager') } catch {} }, 'First')[0].href
}
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    $InstallerFile2 = Join-Path $InstallerFileExtracted 'DFLM.msi'
    # ProductCode
