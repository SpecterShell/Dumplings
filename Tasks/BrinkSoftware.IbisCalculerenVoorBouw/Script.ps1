$InstallerLink = $Global:DumplingsStorage.BrinkSoftwareDownloadPage.Links.Where({ try { $_.href.Contains('.exe') -and $_.OuterHTML.Contains('Ibis Calculeren voor Bouw') -and $_.href.Contains('x64') } catch {} }, 'First')[0]
