$Object1 = Invoke-GitHubApi -Uri 'https://api.github.com/repos/UniRound-Tec/hrack/releases/latest'
    ...
    try {
      ...
      try {
        ...
        $this.CurrentState.Locale += [ordered]@{
          Locale = 'zh-CN'
          Key    = 'ReleaseNotesUrl'
          Value  = $ReleaseNotesUrl = 'https://github.com/UniRound-Tec/hrack/blob/HEAD/CHANGELOG.md'
        }

        $Object2 = Invoke-RestMethod -Uri 'https://raw.githubusercontent.com/UniRound-Tec/hrack/HEAD/CHANGELOG.md' | Convert-MarkdownToHtml
