...
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x64'
  InstallerUrl = "https://sdk.lunarg.com/sdk/download/$($this.CurrentState.Version)/windows/$($Object1.windows.Values[0].files.Where({ $_.name -eq 'SDK' }, 'First')[0].file_name)"
}
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'arm64'
  InstallerUrl = "https://sdk.lunarg.com/sdk/download/$($this.CurrentState.Version)/warm/$($Object1.warm.Values[0].files.Where({ $_.name -eq 'SDK' }, 'First')[0].file_name)"
}
