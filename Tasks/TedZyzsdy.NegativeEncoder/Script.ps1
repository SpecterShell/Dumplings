$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/zyzsdy/NegativeEncoder/releases/latest"

# Version
$this.CurrentState.Version = $Object1.tag_name -replace '^v'

# RealVersion
$this.CurrentState.RealVersion = $Object1.tag_name -replace '^v' -replace '\.0$'
