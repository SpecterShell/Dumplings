function Read-Installer {
  ...
  7z.exe e -aoa -ba -bd -y -o"${InstallerFileExtracted}" $InstallerFile 'GetLocalAdminsGUISetup.exe' | Out-Host
  $InstallerFile2 = Join-Path $InstallerFileExtracted 'GetLocalAdminsGUISetup.exe'
  ...
  $InstallerFile3 = Join-Path $InstallerFile2Extracted 'GetLocalAdminsGUISetup.msi'
  $InstallerFile4 = Join-Path $InstallerFile2Extracted 'GetLocalAdminsGUISetup.x64.msi'
  # Version
...
function Get-ReleaseNotes {
  try {
    $Object3 = Invoke-RestMethod -Uri 'https://cjwdev.com/Software/GetLocalAdminsGUI/LatestVersionV2.xml'
...
$Prefix = 'https://cjwdev.com/Software/GetLocalAdminsGUI/Download.html'
