$Object1 = Invoke-WebRequest -Uri 'https://www.thorlabs.com/api/software_pages/check_updates?ItemID=SA201B' | Read-ResponseContent | ConvertFrom-Xml
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    foreach ($Installer in $this.CurrentState.Installer) {
      ...
      $InstallerInfo = Get-InstallShieldMsiInfo -Path $InstallerFile2 -Name 'SA201B.msi'
      # RealVersion
