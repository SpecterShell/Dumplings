...
$this.CurrentState.Installer += [ordered]@{
  ...
  InstallerUrl  = $Object1.assets.Where({ $_.name -match 'codewhale-tui' -and $_.name.EndsWith('.exe') -and $_.name.Contains('x64') }, 'First')[0].browser_download_url | ConvertTo-UnescapedUri
}
