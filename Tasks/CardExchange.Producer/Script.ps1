$Object1 = $Global:DumplingsStorage.CardExchangeDownloadPage.SelectSingleNode('//tr[contains(@class, "fs-table-row") and contains(./td[contains(@class, "fs-table-title")]//div[contains(@class, "el-title")], "CardExchange® PRODUCER")]')
