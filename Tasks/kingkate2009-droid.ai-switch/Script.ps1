$Object1 = Invoke-GitHubApi -Uri 'https://api.github.com/repos/kingkate2009-droid/ai-switch/releases/latest'
...
$this.CurrentState.Installer += [ordered]@{
  ...
  NestedInstallerFiles = @([ordered]@{ RelativeFilePath = "$($Asset.name | Split-Path -LeafBase)\ai-switch.exe" })
