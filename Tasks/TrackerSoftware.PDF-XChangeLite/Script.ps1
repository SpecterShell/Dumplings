# x86
$Object1 = $Global:DumplingsStorage.TrackerSoftwareApps.UpdaterData.bundle.Where({ $_.id -eq 'DriverLite.x32' }, 'First')[0].update[-1]
$VersionX86 = $Object1.version

# x64
$Object2 = $Global:DumplingsStorage.TrackerSoftwareApps.UpdaterData.bundle.Where({ $_.id -eq 'DriverLite.x64' }, 'First')[0].update[-1]
  ...
  'New|Changed|Updated' {
    try {
      ...
      $this.CurrentState.Locale += [ordered]@{
        Locale = 'en-US'
        Key    = 'ReleaseNotesUrl'
        Value  = 'https://www.pdf-xchange.com/product/pdf-xchange-lite/history'
      }
