# Version
$this.CurrentState.Version = $Global:DumplingsStorage.ApacheGroovyFolders.data.text -match '^groovy-5\.[\d\.]+$' -replace '^groovy-([\d\.]+)$', '$1' |
  Sort-Object -Property { [ChunkVersion]$_ } -Bottom 1
