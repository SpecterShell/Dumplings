function Read-Installer {
  ...
  $this.CurrentState.Installer += [ordered]@{
    InstallerUrl    = "https://download.oracle.com/java/27/archive/jdk-${ShortVersion}_windows-x64_bin.msi"
    InstallerSha256 = $InstallerSha256
  }
  $this.InstallerFiles[$this.CurrentState.Installer[-1].InstallerUrl] = $InstallerFile
}

$Uri = 'https://download.oracle.com/java/27/latest/jdk-27_windows-x64_bin.msi'
