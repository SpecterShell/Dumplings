$Object1 = Invoke-WebRequest -Uri 'https://im.dingtalk.com/manifest/x64/release_windows_vista_later_manual_lowpriority.json' | Read-ResponseContent | ConvertFrom-Json
