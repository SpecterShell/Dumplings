...
function Get-ReleaseNotes {
  try {
    $Object2 = Invoke-WebRequest -Uri 'https://www.axis.com/ftp/pub_soft/cam_srv/optimizer_body_worn/latest/relnote.txt'
...
$Prefix = 'https://www.axis.com/products/axis-body-worn-for-xprotect'
