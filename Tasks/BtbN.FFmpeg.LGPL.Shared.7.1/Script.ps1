...
# Installer
$Asset = $Object1.assets.Where({ $_.name.EndsWith('.zip') -and $_.name.Contains('win64') -and $_.name.Contains('-lgpl') -and $_.name.Contains('shared') -and $_.name.Contains('n7.1') }, 'First')[0]
