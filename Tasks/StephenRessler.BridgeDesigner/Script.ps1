$ProjectName = 'wpbdc'
$RootPath = '/Current Release/jre/'
$PatternPath = ''
$PatternFilename = 'setup[^\d]*(\d+)[^\d]*\.exe'
...
switch -Regex ($this.Check()) {
  ...
  'Updated' {
    $this.Log('The real version is unknown. Get the real version from the program about window', 'Warning')
  }
}
