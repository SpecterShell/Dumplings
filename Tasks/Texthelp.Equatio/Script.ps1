# $Object1 = Invoke-WebRequest -Uri 'https://fastdownloads2.texthelp.com/equatio_desktop/version/winVersion.txt'
...
$Object1 = Invoke-WebRequest -Uri 'https://fastdownloads2.texthelp.com/equatio_desktop/version/index.html'
