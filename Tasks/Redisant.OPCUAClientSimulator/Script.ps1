$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/chenjing1294/OPCUAClientSimulator-release/releases/latest"
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.redisant.com/opcuaclient/download' | ConvertFrom-Html
    ...
    try {
      $Object3 = Invoke-WebRequest -Uri 'https://www.redisant.cn/opcuaclient/download' | ConvertFrom-Html
