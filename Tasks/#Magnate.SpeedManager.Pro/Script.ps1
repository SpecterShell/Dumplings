...
if (Test-Path -Path $OldReleasesPath) {
  $Global:DumplingsStorage['SpeedManagerPro'] = $OldReleases = Get-Content -Path $OldReleasesPath -Raw | ConvertFrom-Yaml -Ordered
} else {
  $Global:DumplingsStorage['SpeedManagerPro'] = $OldReleases = [ordered]@{}
}
