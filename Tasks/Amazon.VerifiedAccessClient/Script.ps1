$Uri1 = 'https://d1wo6wuaox5vq3.cloudfront.net/windows-x86_64/latest/ConnectivityClientInstaller.msi'
...
if ($Global:DumplingsPreference.Contains('Force')) {
  ...
  try {
    $Uri2 = "https://d1wo6wuaox5vq3.cloudfront.net/windows-x86_64/$($this.CurrentState.Version)/ConnectivityClientInstaller.msi"
