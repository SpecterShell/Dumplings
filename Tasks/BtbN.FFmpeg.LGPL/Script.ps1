...
# Installer
$Asset = $Object1.assets.Where({ $_.name.EndsWith('.zip') -and $_.name.Contains('win64') -and $_.name.Contains('-lgpl') -and -not $_.name.Contains('shared') -and $_.name.Contains('N-') }, 'First')[0]
