...
$Object1 = Invoke-WebRequest -Uri 'https://www.altova.com/thankyou?ProductCode=DG&EditionCode=Z&InstallerType=Product&Lang=multi&OperatingSystem=win32'
