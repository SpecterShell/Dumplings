# x64
$Object1 = Invoke-RestMethod -Uri 'https://antigravity-ide-auto-updater-974169037036.us-central1.run.app/api/update/win32-x64-user/stable/latest'
$VersionX64 = [regex]::Match($Object1.url, '(\d+(?:\.\d+)+)').Groups[1].Value
# arm64
$Object2 = Invoke-RestMethod -Uri 'https://antigravity-ide-auto-updater-974169037036.us-central1.run.app/api/update/win32-arm64-user/stable/latest'
