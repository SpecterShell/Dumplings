# x86
$Object1 = Invoke-RestMethod -Uri 'https://utyautoupdate.synology.com/getUpdate/ActiveProtectAgent?os=windows&bits=32&include_beta=false'
$VersionX86 = "$($Object1.version.major).$($Object1.version.minor).$($Object1.version.hotfix)-$($Object1.version.build_number)"
# x64
$Object2 = Invoke-RestMethod -Uri 'https://utyautoupdate.synology.com/getUpdate/ActiveProtectAgent?os=windows&bits=64&include_beta=false'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object3 = Invoke-WebRequest -Uri 'https://www.synology.com/api/releaseNote/findChangeLog?identify=ActiveProtectAgent&lang=en-us' | Read-ResponseContent | ConvertFrom-Json -AsHashtable
    ...
    try {
      $Object4 = Invoke-WebRequest -Uri 'https://www.synology.com/api/releaseNote/findChangeLog?identify=ActiveProtectAgent&lang=zh-cn' | Read-ResponseContent | ConvertFrom-Json -AsHashtable
