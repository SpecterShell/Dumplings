$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/microsoft/XmlNotepad/releases/latest"
...
$this.CurrentState.Installer += [ordered]@{
  InstallerType = 'zip'
  InstallerUrl  = $Object1.assets.Where({ $_.name.EndsWith('.zip') -and $_.name -match 'Setup' }, 'First')[0].browser_download_url | ConvertTo-UnescapedUri
}
