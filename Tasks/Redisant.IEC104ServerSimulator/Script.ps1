$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/chenjing1294/IEC104ServerSimulator-release/releases/latest"
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://www.redisant.com/iec104server/download' | ConvertFrom-Html
    ...
    try {
      $Object3 = Invoke-WebRequest -Uri 'https://www.redisant.cn/iec104server/download' | ConvertFrom-Html
