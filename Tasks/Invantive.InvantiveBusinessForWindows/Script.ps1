...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Global:DumplingsStorage.InvantiveDownloadPage.Links.Where({ try { $_.href.EndsWith('.msi') -and $_.href.Contains('Invantive%20Business%20for%20Windows') } catch {} }, 'First')[0].href | ConvertTo-UnescapedUri
}
