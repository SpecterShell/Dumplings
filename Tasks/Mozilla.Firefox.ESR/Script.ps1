...
switch -Regex ($this.Check()) {
  ...
  'Updated' {
    foreach ($Locale in $Locales) {
      ...
      if ($Locale -eq 'multi') {
        $this.Config.WinGetIdentifier = 'Mozilla.Firefox.ESR.MSIX'
        ...
        if ($Locale -eq 'en-US') {
          $this.Config.WinGetIdentifier = 'Mozilla.Firefox.ESR'
        } else {
          $this.Config.WinGetIdentifier = "Mozilla.Firefox.ESR.${Locale}"
        }
