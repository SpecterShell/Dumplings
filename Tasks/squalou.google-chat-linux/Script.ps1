$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/squalou/google-chat-linux/releases/latest"
  ...
  'New|Changed|Updated' {
    ...
    try {
      ...
      $this.CurrentState.Locale += [ordered]@{
        Key   = 'ReleaseNotesUrl'
        Value = $ReleaseNotesUrl = "https://github.com/squalou/google-chat-linux/blob/master/CHANGELOG.md"
      }

      $Object2 = Invoke-RestMethod -Uri "https://raw.githubusercontent.com/squalou/google-chat-linux/master/CHANGELOG.md" | Convert-MarkdownToHtml
