$Object1 = Invoke-RestMethod -Uri 'https://omnitruck.chef.io/stable/inspec/metadata/?p=windows&pv=10.0.22000&v=latest&m=x86_64&prerelease=false&nightlies=false' -Headers @{
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      $ReleaseNotesRaw = Invoke-RestMethod -Uri "https://packages.chef.io/release-notes/inspec/$($Object1.version).md" | Convert-MarkdownToHtml | Get-TextContent
