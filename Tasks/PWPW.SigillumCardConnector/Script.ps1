...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = Join-Uri $Global:DumplingsStorage.PWPWDownloadPagePrefix $Global:DumplingsStorage.PWPWDownloadPage.Links.Where({ try { $_.href -match 'Sigillumcardconnectorinstaller\.msi$' } catch {} }, 'First')[0].href
}
