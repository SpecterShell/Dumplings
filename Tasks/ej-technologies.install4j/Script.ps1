$Prefix = 'https://download.ej-technologies.com/install4j/'
...
# x64
$Object2 = $Object1.updateDescriptor.entry.Where({ $_.targetMediaFileId -eq '6787' }, 'First')[0]
# arm64
$Object3 = $Object1.updateDescriptor.entry.Where({ $_.targetMediaFileId -eq '8133' }, 'First')[0]
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      $Object2 = (Invoke-RestMethod -Uri 'https://www.ej-technologies.com/feeds/install4j').Where({ $_.title.Contains($this.CurrentState.Version) }, 'First')
