...
$Object2 = $Object1.SelectSingleNode('//div[@class="pdf homeblock"]//a[contains(text(), "DOWNLOAD")]')
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      $Object3 = Invoke-WebRequest -Uri 'https://fineprint.com/pdf/release-notes/' -UserAgent $UserAgent | ConvertFrom-Html
