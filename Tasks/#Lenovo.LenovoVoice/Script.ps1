...
if (Test-Path -Path $OldReleaseNotesPath) {
  $Global:DumplingsStorage['LenovoVoice'] = $OldReleaseNotes = Get-Content -Path $OldReleaseNotesPath -Raw | ConvertFrom-Yaml -Ordered
} else {
  $Global:DumplingsStorage['LenovoVoice'] = $OldReleaseNotes = [ordered]@{}
}
