$Object1 = Invoke-WebRequest -Uri 'https://tachosys.com/Product/digiCentralAuthenticate'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    foreach ($Installer in $this.CurrentState.Installer) {
      ...
      $InstallerFile2 = Join-Path $InstallerFileExtracted 'digiCentral Authenticate.msi'
      # ProductCode
