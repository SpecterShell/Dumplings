# x86
$Prefix1 = 'https://cdn2.wodeabc.com/file/upload/600134/files/update-hesoft-drawing/ia32/'
$Object1 = Invoke-RestMethod -Uri "${Prefix1}latest.yml?noCache=$(Get-Random)" | ConvertFrom-Yaml
# x64
$Prefix2 = 'https://cdn2.wodeabc.com/file/upload/600134/files/update-hesoft-drawing/x64/'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object3 = Invoke-WebRequest -Uri 'https://www.wodeabc.com/article/show/8002658' | ConvertFrom-Html
