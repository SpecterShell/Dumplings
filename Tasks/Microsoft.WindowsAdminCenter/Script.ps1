...
$Object1 = Invoke-WebRequest -Uri 'https://www.microsoft.com/en-us/evalcenter/download-windows-admin-center'

$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = Get-RedirectedUrl -Uri $Object1.Links.Where({ try { $_.outerHTML.Contains('Download now') } catch {} }, 'First')[0].href
}
