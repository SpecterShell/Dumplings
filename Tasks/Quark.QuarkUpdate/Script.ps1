$Object1 = $Global:DumplingsStorage.QuarkApps.ProductsRegister.ProductType.Where({ $_.Type -eq 'Updates' }, 'First')[0].ProductDetails.Where({ $_.ProductCode -eq 'com.quark.QuarkUpdate.2' }, 'First')[0]
