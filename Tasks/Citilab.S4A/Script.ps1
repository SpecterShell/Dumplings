...
$Prefix = 'https://s4a.citilab.eu/'
$Object1 = Invoke-WebRequest -Uri $Prefix

$this.CurrentState.Installer += [ordered]@{
  InstallerUrl         = $InstallerUrl = Join-Uri $Prefix $Object1.Links.Where({ try { $_.href.EndsWith('.zip') -and $_.outerHTML.Contains('Windows') } catch {} }, 'First')[0].href
