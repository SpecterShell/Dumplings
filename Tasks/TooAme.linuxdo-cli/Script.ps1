$Object1 = (Invoke-GitHubApi -Uri 'https://api.github.com/repos/TooAme/linuxdo-explorer/releases').Where({ -not $_.prerelease -and $_.tag_name -match '^CLI' }, 'First')

# Version
$this.CurrentState.Version = $Object1.tag_name -replace '^CLI'
