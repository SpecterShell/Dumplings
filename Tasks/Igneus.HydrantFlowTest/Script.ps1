...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = Join-Uri $Global:DumplingsStorage.IgneusPrefix $Global:DumplingsStorage.IgneusDownloadPage.Links.Where({ $_.href.EndsWith('.exe') -and $_.href -match 'Flow.Test' }, 'First')[0].href
}
