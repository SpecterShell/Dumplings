$Uri1 = 'https://dl.anyware.hp.com/DeAdBCiUYInHcSTy/pcoip-client/raw/names/pcoip-client-exe/versions/latest/pcoip-client_latest.exe'
...
if ($Global:DumplingsPreference.Contains('Force')) {
  ...
  try {
    $Uri2 = "https://dl.anyware.hp.com/DeAdBCiUYInHcSTy/pcoip-client/raw/names/pcoip-client-exe/versions/$('{0}.{1:d2}.{2}' -f @([int[]]$this.CurrentState.Version.Split('.')))/pcoip-client_$('{0}.{1:d2}.{2}' -f @([int[]]$this.CurrentState.Version.Split('.'))).exe"
