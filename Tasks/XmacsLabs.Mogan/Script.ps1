...
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x64'
  InstallerUrl = $Object1.assets.Where({ $_.name.EndsWith('.exe') -and $_.name.Contains('64bit') -and $_.name.Contains('installer') })[0].browser_download_url | ConvertTo-UnescapedUri
}
