# x86
$Object1 = Invoke-WebRequest -Uri 'https://downloads.nomachine.com/download/?id=136'
# x64
$Object2 = Invoke-WebRequest -Uri 'https://downloads.nomachine.com/download/?id=137'
