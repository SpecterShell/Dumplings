$Object1 = Invoke-WebRequest -Uri 'https://www.thorlabs.com/api/software_pages/check_updates?ItemID=SC30' | Read-ResponseContent | ConvertFrom-Xml
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    foreach ($Installer in $this.CurrentState.Installer) {
      ...
      $InstallerInfo = Get-InstallShieldMsiInfo -Path $InstallerFile2 -Name 'TL_DeviceSDK.msi'
      # RealVersion
