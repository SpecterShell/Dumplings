$Object1 = Invoke-RestMethod -Uri 'https://dbeaver.com/product/dbeaver-le-version.xml'
...
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x64'
  Scope        = 'user'
  InstallerUrl = "https://downloads.dbeaver.net/lite/$($this.CurrentState.Version)/dbeaver-le-$($this.CurrentState.Version)-x86_64-setup.exe"
