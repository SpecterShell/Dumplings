$Object1 = Invoke-RestMethod -Uri 'https://content.movavi.com/sparkle/aca/win/x86_64/appcast/appcast.xml'
...
$this.CurrentState.Installer += [ordered]@{
  ...
  ProductCode  = "Movavi Academic $($this.CurrentState.Version.Split('.')[0])"
}
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      ...
      <# The release notes URL redirects to home page
