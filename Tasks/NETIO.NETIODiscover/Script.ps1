...
$Object1 = Invoke-WebRequest -Uri 'https://www.netio-products.com/en/software/netio-discover'
# Installer
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = 'https:' + $Object1.Links.Where({ try { $_.href.EndsWith('.exe') } catch {} }, 'First')[0].href
}
