...
function Get-ReleaseNotes {
  try {
    $Object3 = Invoke-WebRequest -Uri 'https://www.softperfect.com/products/changelog.php?product_id=2' | ConvertFrom-Html
...
$Prefix = 'https://www.softperfect.com/products/networx/'
