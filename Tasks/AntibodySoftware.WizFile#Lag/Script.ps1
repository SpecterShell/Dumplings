...
# RealVersion
$this.CurrentState.RealVersion = $this.LastState.Contains('Version') ? $this.LastState.Version : '3.10'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      ...
      $ReleaseNotesTitleNode = $Object1.SelectSingleNode("//div[@class='blog-content']/h4[contains(./text(), 'WizFile $($this.CurrentState.RealVersion)')]")
