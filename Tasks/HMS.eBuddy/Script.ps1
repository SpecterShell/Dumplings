...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Global:DumplingsStorage.HMSDownloadPage.Links.Where({ try { $_.href.Contains('.msi') -and $_.href.Contains('ebuddy') } catch {} }, 'First')[0].href | Split-Uri -LeftPart 'Path'
}
