...
$Object1 = Invoke-WebRequest -Uri 'https://www.altova.com/thankyou?ProductCode=MF&EditionCode=S&InstallerType=Product&Lang=en&OperatingSystem=win32'

# Installer
# x64 installer is not available in the Basic edition
