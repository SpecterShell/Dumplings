...
$Prefix = 'https://www.loftware.com/customer-center/downloads/nicelabel-download-for-existing-customers'
$Object1 = Invoke-WebRequest -Uri $Prefix | ConvertFrom-Html

$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = Join-Uri $Prefix $Object1.SelectSingleNode('//option[contains(text(), "NiceLabel 10.")]').Attributes['value'].Value
}
