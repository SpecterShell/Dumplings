...
function Get-ReleaseNotes {
  try {
    ...
    $this.CurrentState.Locale += [ordered]@{
      Key   = 'ReleaseNotesUrl'
      Value = 'https://support.blastiq.com/hc/sections/360008467794'
    }

    $Object3 = Invoke-WebRequest -Uri 'https://support.blastiq.com/hc/en-us/sections/360008467794-SHOTPlus-Tunnel' | ConvertFrom-Html
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = 'https://downloads.blastiq.com/installers/shotplust/production/shotplust.installer.production.exe'
}
