...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object3 = (Invoke-RestMethod -Uri 'https://www.qnap.com.cn/api/v1/release-notes/utility/QVR%20Pro%20Client?locale=en').result.notes.Windows.Where({ $_.version -eq $Object1.version }, 'First')
    ...
    try {
      $Object4 = (Invoke-RestMethod -Uri 'https://www.qnap.com.cn/api/v1/release-notes/utility/QVR%20Pro%20Client?locale=zh-cn').result.notes.Windows.Where({ $_.version -eq $Object1.version }, 'First')
