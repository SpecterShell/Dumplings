...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $InstallerUrl = Get-RedirectedUrls -Uri 'https://www.tableau.com/downloads/reader/pc64' -Method GET -Headers @{ 'User-Agent' = $UserAgent } | Select-Object -Last 1
}
