$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/phcode-dev/phoenix-desktop/releases/latest"

# Version
$this.CurrentState.Version = $Object1.tag_name -replace '^prod-app-v'
