$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/zealdocs/zeal/releases/latest"
  ...
  'New|Changed|Updated' {
    try {
      ...
      if (-not [string]::IsNullOrWhiteSpace($Object1.body)) {
        ...
        # Remove header
        $ReleaseNotesObject.SelectNodes('/p[contains(.//a, "Full Changelog")]').ForEach({ $_.Remove() })
        # ReleaseNotes (en-US)
