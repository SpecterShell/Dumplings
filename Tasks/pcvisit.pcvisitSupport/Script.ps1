...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = Get-RedirectedUrls -Uri 'https://lb3.pcvisit.de/v1/hosted/jumplink?func=download&topic=hostSetup&destname=pcvisit_Supporter-Modul_Setup_SJ&os=osWin32' -Method GET | Select-Object -Last 1
}
