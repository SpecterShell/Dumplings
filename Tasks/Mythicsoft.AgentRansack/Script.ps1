$Prefix = 'https://www.mythicsoft.com/agentransack/download/'
$Object1 = curl -fSsLA $DumplingsInternetExplorerUserAgent $Prefix | Join-String -Separator "`n" | Get-EmbeddedLinks

# x86
$InstallerUrlX86 = $Object1.Where({ $_.href -match 'agentransack_x86_msi_(\d+)\.zip$' }, 'First')[0].href
$VersionX86 = $Matches[1]

# x64
$InstallerUrlX64 = $Object1.Where({ $_.href -match 'agentransack_x64_msi_(\d+)\.zip$' }, 'First')[0].href
