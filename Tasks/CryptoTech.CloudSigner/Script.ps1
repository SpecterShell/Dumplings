...
$Object2 = $Object1.SelectSingleNode('//div[contains(@class, "entry-content")]/div/section[contains(@class, "vc_section")]/div[contains(@class, "vc_row ") and contains(.//h2, "CryptoCard CloudSigner (32bit MSI)")]')
$VersionX86 = [regex]::Match($Object2.InnerText, 'wersja (\d+(?:\.\d+)+)').Groups[1].Value
$Object3 = $Object1.SelectSingleNode('//div[contains(@class, "entry-content")]/div/section[contains(@class, "vc_section")]/div[contains(@class, "vc_row ") and contains(.//h2, "CryptoCard CloudSigner (64bit MSI)")]')
