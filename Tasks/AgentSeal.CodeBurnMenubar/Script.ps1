# The Windows build ships on its own release tag (windows-vX.Y.Z); the main vX.Y.Z release has no assets.
$Object1 = (Invoke-GitHubApi -Uri 'https://api.github.com/repos/getagentseal/codeburn/releases').Where({ $_.tag_name.StartsWith('windows-') }, 'First')[0]
