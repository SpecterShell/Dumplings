...
if (Test-Path -Path $OldReleasesPath) {
  $Global:DumplingsStorage['Frhelper'] = $OldReleases = Get-Content -Path $OldReleasesPath -Raw | ConvertFrom-Yaml -Ordered
} else {
  $Global:DumplingsStorage['Frhelper'] = $OldReleases = [ordered]@{}
}
