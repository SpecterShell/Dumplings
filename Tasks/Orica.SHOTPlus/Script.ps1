...
function Get-ReleaseNotes {
  try {
    ...
    $this.CurrentState.Locale += [ordered]@{
      Key   = 'ReleaseNotesUrl'
      Value = 'https://support.blastiq.com/hc/sections/360008032393'
    }

    $Object3 = Invoke-WebRequest -Uri 'https://support.blastiq.com/hc/en-us/sections/360008032393-SHOTPlus' | ConvertFrom-Html
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = 'https://downloads.blastiq.com/installers/shotplus6/production/shotplus6.installer.production.exe'
}
