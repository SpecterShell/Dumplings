$Object1 = (Invoke-GitHubApi -Uri "https://api.github.com/repos/brechtsanders/winlibs_mingw/releases").Where({ -not $_.prerelease -and $_.tag_name.Contains('posix') -and $_.tag_name.Contains('msvcrt') -and $_.tag_name -notmatch 'snapshot' }, 'First')[0]
