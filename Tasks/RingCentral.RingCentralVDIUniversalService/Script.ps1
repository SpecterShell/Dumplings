$Uri1 = 'https://app.ringcentral.com/download/vdi/RingCentral-App-VdiUniversalService.msi'
...
if ($Global:DumplingsPreference.Contains('Force')) {
  ...
  try {
    $Uri2 = "https://app.ringcentral.com/download/vdi/RingCentral-App-VdiUniversalService-$($this.CurrentState.Version).msi"
