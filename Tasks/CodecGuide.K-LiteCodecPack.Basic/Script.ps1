...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = "https://files2.codecguide.com/K-Lite_Codec_Pack_$($Object1.Complete.version)_Basic.exe"
}
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      $Object2 = Invoke-WebRequest -Uri 'https://codecguide.com/changelogs_basic.htm' | ConvertFrom-Html
