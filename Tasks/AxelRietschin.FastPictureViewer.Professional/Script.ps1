...
function Get-ReleaseNotes {
  try {
    $Object2 = Invoke-WebRequest -Uri 'https://www.fastpictureviewer.com/downloads/' | ConvertFrom-Html

    $ReleaseNotesNode = $Object2.SelectSingleNode("//tr[contains(./td[1]/text(), '$($this.CurrentState.Version)')]")
    if ($ReleaseNotesNode) {
      # ReleaseTime
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = 'https://cdn.fastpictureviewer.com/bin/FastPictureViewer64.msi'
}
