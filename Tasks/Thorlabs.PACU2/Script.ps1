$Object1 = Invoke-WebRequest -Uri 'https://www.thorlabs.com/api/software_pages/check_updates?ItemID=PACU2' | Read-ResponseContent | ConvertFrom-Xml
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      ...
      #   Locale = 'en-US'
      #   Key    = 'LicenseUrl'
      #   Value  = "https://www.thorlabs.com/software/THO/PACU2/V$($this.CurrentState.Version)/License.zip"
      # }
    } catch {
      $_ | Out-Host
      $this.Log($_, 'Warning')
