...
$Object1 = Invoke-WebRequest -Uri 'https://support.avaya.com/public/index?page=content&id=ADMN116826'

$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = $Object1.Links.Where({ try { $_.href.EndsWith('.msi') -and $_.href -match 'AvayaCloudOfficeForTeamsDesktopPlugin' } catch {} }, 'First')[0].href
}
