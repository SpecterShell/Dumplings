$Object1 = Invoke-GitHubApi -Uri 'https://api.github.com/repos/blueberrycongee/Lumina-Note/releases/latest'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    try {
      ...
      if (-not [string]::IsNullOrWhiteSpace($Object1.body) -and -not $Object1.body.Trim() -eq 'See the assets to download and install this version.') {
        # ReleaseNotes (zh-CN)
