...
if (Test-Path -Path $OldReleaseNotesPath) {
  $Global:DumplingsStorage['Eshelper'] = $OldReleaseNotes = Get-Content -Path $OldReleaseNotesPath -Raw | ConvertFrom-Yaml -Ordered
} else {
  $Global:DumplingsStorage['Eshelper'] = $OldReleaseNotes = [ordered]@{}
}
