...
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x86'
  InstallerUrl = $Object1.Version.URL.Replace('www.anyburn.com', 'anyburn.com')
}
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'x64'
  InstallerUrl = $Object1.Version.'URL.X64'.Replace('www.anyburn.com', 'anyburn.com')
}
$this.CurrentState.Installer += [ordered]@{
  Architecture = 'arm64'
  InstallerUrl = $Object1.Version.'URL.X64'.Replace('www.anyburn.com', 'anyburn.com') -replace 'x64', 'arm64'
}
