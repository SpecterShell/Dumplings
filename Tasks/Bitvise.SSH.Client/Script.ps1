$Object1 = Invoke-WebRequest -Uri 'https://bitvise.com/versions/BvSshClient'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    try {
      ...
      $ReleaseNotesTitleNode = $Object3.SelectSingleNode("//div[@id='content']//p[contains(., 'Changes in Bitvise SSH Client $($this.CurrentState.Version)')]")
