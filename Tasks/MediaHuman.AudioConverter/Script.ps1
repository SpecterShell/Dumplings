...
function Get-ReleaseNotes {
  try {
    $Object2 = Invoke-WebRequest -Uri 'https://www.mediahuman.com/audio-converter/changelog.html' | ConvertFrom-Html
...
$this.CurrentState.Installer += $InstallerX86 = [ordered]@{
  Architecture = 'x86'
  InstallerUrl = 'https://www.mediahuman.com/files/MHAudioConverter.exe'
}
...
$this.CurrentState.Installer += $InstallerX64 = [ordered]@{
  Architecture = 'x64'
  InstallerUrl = 'https://www.mediahuman.com/files/MHAudioConverter-x64.exe'
}
