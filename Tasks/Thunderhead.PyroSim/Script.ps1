$ReleaseNotesUrl = 'https://www.thunderheadeng.com/docs/latest/pyrosim/'
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = [regex]::Match($Object2.Content, '"(https://www.thunderheadeng.net/releases/PyroSim-[^"]+?\.msi)"').Groups[1].Value
}
