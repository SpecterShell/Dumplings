...
if (Test-Path -Path $OldReleaseNotesPath) {
  $Global:LocalStorage['TickTick'] = $OldReleaseNotes = Get-Content -Path $OldReleaseNotesPath -Raw | ConvertFrom-Yaml -Ordered
} else {
  $Global:LocalStorage['TickTick'] = $OldReleaseNotes = [ordered]@{}
}
