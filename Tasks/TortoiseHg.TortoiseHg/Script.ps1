...
$InstallerObjectX86 = $Object1 | Where-Object -FilterScript { -not $_.Version.Contains('rc') -and $_.InstallerUrl.Contains('x86') -and $_.InstallerUrl.EndsWith('.msi') } | Sort-Object -Property { [ChunkVersion]($_.Version) } -Bottom 1
$InstallerObjectX64 = $Object1 | Where-Object -FilterScript { -not $_.Version.Contains('rc') -and $_.InstallerUrl.Contains('x64') -and $_.InstallerUrl.EndsWith('.msi') } | Sort-Object -Property { [ChunkVersion]($_.Version) } -Bottom 1
