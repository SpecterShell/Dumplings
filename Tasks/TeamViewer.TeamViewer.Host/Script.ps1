function Read-Installer {
  ...
  $this.CurrentState.Installer += [ordered]@{
    ...
    InstallerUrl        = "https://download.teamviewer.com/download/version_15x/update/Update_msi_Host_$($this.CurrentState.Version).zip"
  }
  $this.CurrentState.Installer += [ordered]@{
    Architecture        = 'x64'
    InstallerType       = 'zip'
    NestedInstallerType = 'wix'
    InstallerUrl        = "https://download.teamviewer.com/download/version_15x/update/Update_msi_Host_$($this.CurrentState.Version)_x64.zip"
  }
}
