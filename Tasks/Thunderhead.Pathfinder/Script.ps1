$ReleaseNotesUrl = 'https://www.thunderheadeng.com/docs/latest/pathfinder/'
...
$this.CurrentState.Installer += [ordered]@{
  InstallerUrl = [regex]::Match($Object2.Content, '"(https://www.thunderheadeng.net/releases/Pathfinder-[^"]+?\.msi)"').Groups[1].Value
}
