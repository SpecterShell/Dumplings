$Object1 = Invoke-GitHubApi -Uri "https://api.github.com/repos/elastic/beats/releases/latest"
...
$this.CurrentState.Installer += [ordered]@{
  Architecture  = 'x64'
  InstallerType = 'wix'
  InstallerUrl  = "https://artifacts.elastic.co/downloads/beats/metricbeat/metricbeat-$($this.CurrentState.Version)-windows-x86_64.msi"
}
