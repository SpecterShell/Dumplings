...
Read [InstallBuilder Parser Internals](../../internals/installbuilder/overview.md) before changing detection, extraction, binary decoding, or parser limits.

### Parse project metadata and expand payloads
...
### Resolve uninstaller and ARP identity
...
### Validate GUI help and runtime conditions
...
Follow [VM validation workflow](../../workflows/vm-validation.md) when scope, unattended UI mode, required `--prefix`, overwrite behavior, or visible ARP registration remains conditional.
