...
4. Read [InstallShield internals](../../internals/installshield/overview.md) when the setup's project model, runtime lifecycle, media generation, or nested package ownership is unclear.
